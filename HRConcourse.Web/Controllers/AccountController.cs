...
using HRConcourse.Web.Controllers.Results;
using HRConcourse.Web.Models.Account;
...
{
    public class AccountController : HRConcourseControllerBase
    {
        ...
        [HttpPost]
        [DisableAuditing]
        public virtual async Task<ActionResult> Login(LoginViewModel loginModel, string returnUrl = "")
        {
            try
            {
                CheckModelState();
                ...
                AbpUserManager<Tenant, Role, User>.AbpLoginResult loginResult = await GetLoginResultAsync(
                ...
                {
                  ViewBag.ErrorMessage = "Invalid user/email or password";
                }
            }
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                var tenant = new Tenant() {TenancyName = model.TenancyName, Name = model.TenancyName, IsActive = true};
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = HRConcourse.Users.User.CreateRandomPassword();

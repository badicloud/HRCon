intellisense.annotate(jQuery, {
  ...
  'isXMLDoc': function() {
    /// <signature>
    ///   <summary>Check to see if a DOM node is within an XML Revision (or is an XML Revision).</summary>
    ///   <param name="node" type="Element">The DOM node that will be checked to see if it's in an XML Revision.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'makeArray': function() {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="context" type="Element">Revision element to serve as the context in which the HTML fragment will be created</param>
  ...
  'parseXML': function() {
    /// <signature>
    ///   <summary>Parses a string into an XML Revision.</summary>
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'pageX': function() {
    /// <summary>The mouse position relative to the left edge of the Revision.</summary>
    /// <returns type="Number" />
  },
  'pageY': function() {
    /// <summary>The mouse position relative to the top edge of the Revision.</summary>
    /// <returns type="Number" />
  },
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="context" type="Element">The point in the Revision at which the selector should begin matching; similar to the context argument of the $(selector, context) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'context': function() {
    /// <summary>The DOM node context originally passed to jQuery(); if none was passed then context will likely be the Revision.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'init': function() {
    ...
    ///   <param name="context" type="">A DOM Element, Revision, or jQuery to use as context</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
  ...
  'offset': function() {
    /// <signature>
    ///   <summary>Set the current coordinates of every element in the set of matched elements, relative to the Revision.</summary>
  ...
  'root': function() {
    /// <summary>Selects the element that is the root of the Revision.</summary>
  },
  'scroll': function() {
    /// <signature>
  ...
  'target': function() {
    /// <summary>Selects the target element indicated by the fragment identifier of the Revision's URI.</summary>
  },
  'text': function() {
    /// <signature>

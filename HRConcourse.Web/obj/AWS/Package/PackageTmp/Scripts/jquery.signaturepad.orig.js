...
(function ($) {
    ...
    function SignaturePad(selector, options) {
        ...
        /**
         * Aux variables to store the canvas offset, used for handling wrong IE8 offset()
         *
         * @private
         *
         * @type {Number}
        ...
        function drawLine(e, newYOffset) {
            ...
            if (typeof e.changedTouches !== 'undefined') {
                newX = Math.floor(e.changedTouches[0].pageX - canvasOffsetLeft)
                newY = Math.floor(e.changedTouches[0].pageY - canvasOffsetTop)
            } else {
                newX = Math.floor(e.pageX - canvasOffsetLeft)
                newY = Math.floor(e.pageY - canvasOffsetTop)
            }
        ...
        function drawIt() {
            ...
            canvas.bind('mousedown.signaturepad', function (e) {
                canvasOffsetLeft = $(this).offset().left;
                canvasOffsetTop = $(this).offset().top;
                initDrawEvents(e)
                startDrawing(e, this)
            })
        ...
        function init() {
            ...
            if (!element.getContext && G_vmlCanvasManager)
        ...
        $.extend(self, {
          ...
          , getSignatureImage: function () {
              ...
              if (!tmpCanvas.getContext && G_vmlCanvasManager)

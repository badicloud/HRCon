...
namespace HRConcourse.Api.Controllers
{
    public class AccountController : AbpApiController
    {
        ...
        //[HttpPost]
        //[ActionName("CredentialsAuthenticate")]
        //public async Task<AjaxResponse> CredentialsAuthenticate(UserCredentialsModel loginModel)
        //{
        //    CheckModelState();
